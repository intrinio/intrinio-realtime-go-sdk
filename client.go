...
func (client *Client) trySetToken() bool {
	...
	req.Header.Add("Client-Information", "IntrinioRealtimeOptionsGoSDKv2.2")
...
func (client *Client) initWebSocket(token string) {
	...
	wsHeader := map[string][]string{"UseNewEquitiesFormat": {"v2"}, "Client-Information": {"IntrinioRealtimeOptionsGoSDKv2.2"}}
